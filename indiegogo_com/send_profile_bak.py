...
import psutil
from indiegogo_com.indiegogo_com_util import IndiegogoCom
...
if __name__ == "__main__":
    ...
    for i in range(0, ADD_ONE_ASSIGNMENT_THREAD_NUM):
        obj_list.append(IndiegogoCom(EACH_THREAD_ASSIGNMENT_NUM + 1))
    if EACH_THREAD_ASSIGNMENT_NUM != 0:
        for i in range(0, REMAIN_THREAD_NUM):
            obj_list.append(IndiegogoCom(EACH_THREAD_ASSIGNMENT_NUM))
